                    ...
                    return (
                      <div key={track.key} className="flex items-center gap-2 rounded-lg border border-black/8 bg-panel/30 px-2.5 py-2 text-xs">
                        ...
                        <button
                          ...
                          className="flex shrink-0 items-center gap-1 rounded-[10px] border border-gold/40 px-2 py-1 text-[11px] font-semibold text-gold hover:bg-gold/10 disabled:opacity-40"
                          title="Add Song"
                        >

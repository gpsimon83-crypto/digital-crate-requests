  ...
  return (
    <div className="flex items-center gap-2.5 border-b border-black/8 bg-panel/40 px-4 py-2.5 text-xs sm:px-8">
      <Link
        ...
        className="flex items-center gap-1 rounded-[10px] border border-black/10 px-2.5 py-1 font-medium text-muted transition-colors hover:border-gold/40 hover:text-gold"
      >
      ...
      {event?.title && (
        <span className="truncate text-muted">
          <span className="mr-2 text-black/20">/</span>
          {event.title}

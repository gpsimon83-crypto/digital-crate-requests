        ...
        <div className="flex flex-col gap-4">
          {templates.length > 0 && (
            <label className="block">
              ...
              <select
                ...
                className="w-full rounded-[10px] border border-gold/30 bg-panel px-3 py-2 text-sm focus:border-gold focus:outline-none"
              >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="rounded-[10px] border border-black/12 px-3 py-1.5 text-xs font-medium text-muted hover:border-black/25 hover:text-foreground"
            >

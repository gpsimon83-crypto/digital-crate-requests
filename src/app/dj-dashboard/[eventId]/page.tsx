          ...
          <div className="grid gap-3 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="rounded-[10px] border border-black/15 px-3 py-1.5 text-xs text-muted hover:text-foreground"
                >
                  − $1
                </button>
            ...
            <label className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full rounded-[10px] border border-black/10 bg-panel px-4 py-2 text-sm focus:border-gold focus:outline-none"
              />
            </label>
          </div>
        </GlassCard>
